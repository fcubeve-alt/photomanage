...
let package = Package(
    ...
    targets: [
        ...
        .testTarget(
            ...
            path: "Tests/PVMCoreTests",
            // Resources/ holds the shared fixture and the engine's answers to it,
            // generated by 40_APP/generate_shared.py. The conformance test reads them
            // from the source tree via #filePath rather than through a resource
            // bundle — `Bundle.module` with a nil extension is a Linux Foundation path
            // that crashes, and the files are right next to the test anyway.
            exclude: ["Resources"]
        ),
    ]
)
