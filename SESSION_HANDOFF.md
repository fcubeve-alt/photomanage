...
| Numbers | Classifier unchanged where it should be: macro **F1 0.997**, leaf exact **99.8%**, **0** wrong roots. Automation Ratio 94.1%, Human Review Burden 59/1,000, Catastrophic Error Rate 0, Coverage 94.8%. **Five** safety red lines now, all PASS, checked against the written rows rather than the code. 294 Python tests. |
